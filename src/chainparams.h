...
// Copyright (c) 2017 The Cryptocashback Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOIN_CHAINPCCBCMS_H
#define BITCOIN_CHAINPCCBCMS_H
 ...
 * Cryptocashback system. There are three: the main network on which people trade goods
...
public:
    ...
    virtual void setRejectBlockOutdatedMajority(int CCBCejectBlockOutdatedMajority) = 0;
