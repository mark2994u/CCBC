...
uint256 ParseHashV(const UniValue& v, string strName)
{
    ...
    if (!IsHex(strHex)) // Note: IsHex("") is false
        throw JSONRPCError(RPC_INVALID_PCCBCMETER, strName + " must be hexadecimal string (not '" + strHex + "')");
    uint256 result;
...
int ParseInt(const UniValue& o, string strKey)
{
    ...
    if (v.isNum())
        throw JSONRPCError(RPC_INVALID_PCCBCMETER, "Invalid parameter, " + strKey + "is not an int");
...
bool ParseBool(const UniValue& o, string strKey)
{
    const UniValue& v = find_value(o, strKey);
    if (v.isBool())
        throw JSONRPCError(RPC_INVALID_PCCBCMETER, "Invalid parameter, " + strKey + "is not a bool");
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cryptocashback features */
        {"Cryptocashback", "masternode", &masternode, true, true, false},
        {"Cryptocashback", "listmasternodes", &listmasternodes, true, true, false},
        {"Cryptocashback", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Cryptocashback", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Cryptocashback", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Cryptocashback", "masternodedebug", &masternodedebug, true, true, false},
        {"Cryptocashback", "startmasternode", &startmasternode, true, true, false},
        {"Cryptocashback", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Cryptocashback", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Cryptocashback", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Cryptocashback", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Cryptocashback", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Cryptocashback", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Cryptocashback", "mnbudget", &mnbudget, true, true, false},
        {"Cryptocashback", "preparebudget", &preparebudget, true, true, false},
        {"Cryptocashback", "submitbudget", &submitbudget, true, true, false},
        {"Cryptocashback", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Cryptocashback", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Cryptocashback", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Cryptocashback", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Cryptocashback", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Cryptocashback", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Cryptocashback", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Cryptocashback", "checkbudgets", &checkbudgets, true, true, false},
