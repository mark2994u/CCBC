...
UniValue importaddress(const UniValue& params, bool fHelp)
{
    ...
    if (address.IsValid()) {
        ...
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid CCBC address or script");
    }
...
UniValue importwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!file.is_open())
        throw JSONRPCError(RPC_INVALID_PCCBCMETER, "Cannot open wallet dump file");
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"CCBCaddress\"   (string, required) The CCBC address for the private key\n"
            "\nResult:\n"
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Cryptocashback %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"CCBCaddress\"   (string, required) The CCBC address for the private key (you must hold the key already)\n"
