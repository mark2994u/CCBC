...
typedef enum BCCBCeason
{
    BCCBCeasonUnknown          = 0,
    BCCBCeasonNodeMisbehaving  = 1,
    BCCBCeasonManuallyAdded    = 2
} BCCBCeason;
...
public:
    ...
    void SetNull()
    {
        ...
        nCreateTime = 0;
        nBanUntil = 0;
        bCCBCeason = BCCBCeasonUnknown;
    }

    std::string bCCBCeasonToString()
    {
        switch (bCCBCeason) {
        case BCCBCeasonNodeMisbehaving:
            return "node misbehabing";
        case BCCBCeasonManuallyAdded:
...
public:
    ...
    static void Ban(const CNetAddr &ip, const BCCBCeason &bCCBCeason, int64_t bantimeoffset = 0, bool sinceUnixEpoch = false);
    static void Ban(const CSubNet &subNet, const BCCBCeason &bCCBCeason, int64_t bantimeoffset = 0, bool sinceUnixEpoch = false);
