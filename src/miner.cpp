...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("CryptocashbackMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("CryptocashbackMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("CryptocashbackMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running CryptocashbackMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
