...
Intro
-----
Cryptocashback (CCBC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Cryptocashback utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run Cryptocashback-qt.exe.

Cryptocashback Core is the original Cryptocashback client and it builds the backbone of the network.
However, it downloads and stores the entire history of Cryptocashback transactions;
