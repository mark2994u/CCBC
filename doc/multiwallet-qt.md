...
In order to support loading of multiple wallets in Cryptocashback-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Cryptocashback.cpp.
...
Changes to Cryptocashback.cpp
----------------------
Cryptocashback.cpp is the entry point into Cryptocashback-qt, and as such, will require some minor modifications to provide hooks for
