Contributing to Cryptocashback Core
==================================

The Cryptocashback Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cryptocashback Core project, and is not to be
confused with overall Cryptocashback Network Protocol consensus changes.

Whether a pull request is merged into Cryptocashback Core rests with the project merge
...
Patches that change Cryptocashback consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cryptocashback consensus, it must have been
...
The project leader is the release manager for each Cryptocashback Core release.
