...
#   c) node1 mines 32 blocks, so now node 0 has 500000CCBC, node 1 has 4250CCBC, node2 has none.
#   d) node0 sends 601 CCBC to node2, in two transactions (301 CCBC, then 300 CCBC).
