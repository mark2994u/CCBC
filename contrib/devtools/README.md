...
Cryptocashback/Cryptocashback repository.
...
Setup
---------
Configuring the github-merge tool for the Cryptocashback repository is done in the following way:

    git config githubmerge.repository Cryptocashback/Cryptocashback
...
A script to optimize png files in the Cryptocashback
